...
pub struct ChatCompletionRequest {
    ...
    /// nullable: true
    /// default: false
    /// If set, partial message deltas will be sent, like in ChatGPT. Tokens will be sent as data-only server-sent events as they become available, with the stream terminated by a data: [DONE] message.    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
