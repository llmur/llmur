...
class Config:
    ...
    AZURE_OPENAI_CHAT_COMPLETIONS_BATCH_DEPLOYMENT = os.getenv('AZURE_OPENAI_CHAT_COMPLETIONS_BATCH_DEPLOYMENT')
    AZURE_OPENAI_EMBEDDINGS_BATCH_DEPLOYMENT = os.getenv('AZURE_OPENAI_EMBEDDINGS_BATCH_DEPLOYMENT')
